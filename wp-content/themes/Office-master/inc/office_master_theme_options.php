<?php
    ...
    Redux::setSection($opt_name, array(
        ...
        'desc' => __('This is Header Options','office_master'),
        'icon' => 'el el-home-alt',
    ));

    Redux::setSection($opt_name, array(
        'id' => 'header_sub_options',
        'title' => __('Logo Options','office_master'),
        'subsection' => true,
        'fields' => array(
            array(
                'id'=>'site_logo',
...
//Footer Options
    Redux::setSection($opt_name,array(
        ...
        'desc' => __('Update your Footer options','office_master'),
        'icon' => 'el el-folder-open',
    ));
    Redux::setSection($opt_name,array(
        'id' => 'footer_sub_options',
        'title' => __('Footer Sub Options','office_master'),
        'subsection' => true,
        'fields' => array(
            array(
                'id' => 'copy_text',
                'title' => __('Copyright Text','office_master'),
                'type' => 'editor',
                'default' => '&copy; All Right Reserved Office Master',                
            ),
        ),
    ));
    Redux::setSection($opt_name,array(
        ...
        'fields' => array(
            array(
                'id' => 'col_one_title',
                'title' => __('Column One Title','office_master'),
                'type' => 'text',
                'default' => 'Contact',                
            ),
            array(
                'id' => 'col_one_icon',
                'title' => __('Column One Icon','office_master'),
                'type' => 'text',
    ...
    Redux::setSection($opt_name,array(
        ...
        'fields' => array(
            array(
                'id' => 'col_two_title',
                'title' => __('Column two Title','office_master'),
                'type' => 'text',
                'default' => 'Links',                
            ),
            array(
                'id' => 'col_two_icon',
                'title' => __('Column Two Icon','office_master'),
                'type' => 'text',
    ...
    Redux::setSection($opt_name,array(
        ...
        'fields' => array(
            array(
                'id' => 'col_three_title',
                'title' => __('Column three Title','office_master'),
                'type' => 'text',
                'default' => 'Socialize',                
            ),
            array(
                'id' => 'col_three_icon',
                'title' => __('Column three Icon','office_master'),
                'type' => 'text',
                'default' => 'fa fa-heart',                
            ),
        ),
...
//Header Options
    Redux::setSection($opt_name, array(
        'id' => 'contact_options',
        'title' => __('Contact Page Options','office_master'),
        'desc' => __('This is Contact Page Options','office_master'),
        'icon' => 'el el-address-book',
    ));

    Redux::setSection($opt_name,array(
        'id' => 'contact_map_options',
        'title' => __('Contact Map','office_master'),
        'subsection' => true,
        'fields' => array(
            array(
                'id' => 'map_url',
                'title' => __('Map URL','office_master'),
                'desc' => __('Add Your Map location\'s url','office_master'),
                'type' => 'text',
    ...
    Redux::setSection($opt_name,array(
        'id' => 'contact_left_options',
        'title' => __('Contact Left Options','office_master'),
        'subsection' => true,
        'fields' => array(
            array(
                'id' => 'contact_title',
                'title' => __('Contact Title','office_master'),
                'type' => 'text',
                'default' => 'Find us at',                
            ),
            array(
                'id' => 'contact_textarea',
                'title' => __('Contact Textarea','office_master'),
                'type' => 'editor',                
                'default' => '<p class="block-author"> Johns, Smith &copy; Associates</p>
            ...
            array(
                'id' => 'contact_social_heading',
                'title' => __('Contact Social Heading','office_master'),
                'type' => 'text',
                'default' => 'Social Link',                
            ),
            array(
                'id' => 'contact_social_button',
                'title' => __('Contact Social Button','office_master'),
                'type' => 'slides',
                'placeholder' => array(
                    'title' => 'Social Title',
                    'url' => 'Social Icon',
...
//Sorter Options
    Redux::setSection($opt_name, array(
        'id' => 'sorter_options',
        'title' => __('Sorter Options','office_master'),
        'desc' => __('This is Sorter Options','office_master'),
        'icon' => 'el el-braille',
    ));
    Redux::setSection($opt_name, array(
        'id' => 'section_sorter_sub_options',
        'title' => __('Sorter Options','office_master'),
        'subsection' => true,
        'fields' => array(
            array(
...
//Sorter Options
    ...
    Redux::setSection($opt_name, array(
        ...
        'title' => __('Footer Top Options','office_master'),
        'subsection' => true,
        'fields' => array(
            array(
                'id' => 'footer_top_bg',
                'title' => __('Footer Top Background','office_master'),
                'type' => 'color',               
            ),
            array(
                'id' => 'contact_txt_typo',
                'title' => __('Contact Text typography','office_master'),
                'type' => 'typography',               
                'output' => array(
                    '.footer-contact',
                ),               
